...
import eval.mikolo.mikolo.model.laptop.stat.StatBeneficeMois;
import eval.mikolo.mikolo.model.laptop.stat.StatVenteMoisPDV;
...
public class LaptopRepository {
    ...
    public List<StatBeneficeMois> getStatistiqueBeneficeTotalMois(int annee) {
        String sql="select*from v_benefice_total where annee=:annee";
        Query query=entityManager.createNativeQuery(sql, StatBeneficeMois.class);
        query.setParameter("annee", annee);
        return query.getResultList();
    }

    public List<StatVenteMoisPDV> getStatistiqueVenteTotalMoisParPDV(int annee, int idPointVente) {
        String sql="";
        if(idPointVente!=0) {
            sql="select*from v_stat_vente_total_mois_pdv where annee=:annee and id_point_vente=:idPointVente";
        } else {
            sql="select*from v_stat_vente_total_mois_pdv where annee=:annee and id_point_vente!=:idPointVente";
        }
        Query query=entityManager.createNativeQuery(sql, StatVenteMoisPDV.class);
        query.setParameter("annee", annee);
    ...
    public List<VenteLaptop> findVenteLaptopByIdPointVente(int idPointVente, int numPage) {
        String requete="select*from vente_laptop where id_point_vente=:idPointVente limit 5 offset :debut";
        Query query=entityManager.createNativeQuery(requete, VenteLaptop.class);
        query.setParameter("idPointVente", idPointVente);
        query.setParameter("debut", (numPage-1)*5);
        return query.getResultList();
    }

    public List<VenteLaptop> findVenteLaptopByIdPointVenteInfPrix(int idPointVente, int numPage, int prix) {
        String requete="select*from vente_laptop where id_point_vente=:idPointVente and (prix_vente*quantite_laptop)<=:prix limit 5 offset :debut";
        Query query=entityManager.createNativeQuery(requete, VenteLaptop.class);
        query.setParameter("idPointVente", idPointVente);
        query.setParameter("debut", (numPage-1)*5);
    ...
    public List<VenteLaptop> findVenteLaptopByIdPointVenteAndIdLaptopInfPrix(
        int idPointVente, 
        int numPage, 
        int idLaptop, 
        int prix
    ) {
        String requete="select*from vente_laptop where id_point_vente=:idPointVente and id_laptop=:idLaptop and (prix_vente*quantite_laptop)<=:prix limit 5 offset :debut";
        Query query=entityManager.createNativeQuery(requete, VenteLaptop.class);
        query.setParameter("idPointVente", idPointVente);
        query.setParameter("debut", (numPage-1)*5);
        query.setParameter("idLaptop", idLaptop);
        query.setParameter("prix", prix);
        return query.getResultList();
    }

    public List<VenteLaptop> findVenteLaptopByIdPointVenteBetweenDeuxPrix(
        int idPointVente, 
        int numPage, 
        int prixMin, 
        int prixMax
    ) {
        String requete="select*from vente_laptop where id_point_vente=:idPointVente and (prix_vente*quantite_laptop) between :prixMin and :prixMax limit 5 offset :debut";
        Query query=entityManager.createNativeQuery(requete, VenteLaptop.class);
        query.setParameter("idPointVente", idPointVente);
        query.setParameter("debut", (numPage-1)*5);
    ...
    public List<VenteLaptop> findVenteLaptopByIdPointVenteAndIdLaptopBetweenDeuxPrix(
        int idPointVente, 
        int numPage, 
        int idLaptop,
        int prixMin, 
        ...
        String requete="select*from vente_laptop where id_point_vente=:idPointVente and id_laptop=:idLaptop and (prix_vente*quantite_laptop) between :prixMin and :prixMax limit 5 offset :debut";
        Query query=entityManager.createNativeQuery(requete, VenteLaptop.class);
        query.setParameter("idPointVente", idPointVente);
        query.setParameter("idLaptop", idLaptop);
        query.setParameter("debut", (numPage-1)*5);
    ...
    public List<VenteLaptop> findVenteLaptopByIdLaptop(int idPointVente, int numPage, int idLaptop) {
        String requete="select*from vente_laptop where id_point_vente=:idPointVente and id_laptop=:idLaptop limit 5 offset :debut";
        Query query=entityManager.createNativeQuery(requete, VenteLaptop.class);
        query.setParameter("idPointVente", idPointVente);
        query.setParameter("idLaptop", idLaptop);
        return query.getResultList();
    ...
    public List<VenteLaptop> findVenteLaptopByIdPointVenteSupPrix(int idPointVente, int numPage, int prix) {
        String requete="select*from vente_laptop where id_point_vente=:idPointVente and (prix_vente*quantite_laptop)>=:prix limit 5 offset :debut";
        Query query=entityManager.createNativeQuery(requete, VenteLaptop.class);
        query.setParameter("idPointVente", idPointVente);
        query.setParameter("debut", (numPage-1)*5);
    ...
    public List<VenteLaptop> findVenteLaptopByIdPointVenteAndIdLaptopSupPrix(
        int idPointVente, 
        int numPage, 
        int idLaptop, 
        int prix
    ...
    public int countNbpageVenteLaptop() {
        String sql="select*from v_nb_pages_vente_laptop";
        Query query=entityManager.createNativeQuery(sql);
        return ((Number) query.getSingleResult()).intValue();
    }
