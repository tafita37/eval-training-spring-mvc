...
public class LaptopController {
    ...
    public ResponseEntity<Hashtable<String, Object>> receiveLaptop(
        @RequestHeader Map<String, String> headers, 
        @RequestBody ReceptionLaptop receptionLaptop
    )
    throws Exception {
        Hashtable<String, Object> result=new Hashtable<>();
        String token=headers.get("authorization").substring(7);
        receptionLaptop.setTransfertLaptop(
            laptopService.findTransfertLaptopById(
                receptionLaptop.getTransfertLaptop().getIdTransfertLaptop()
            )
        );
    ...
    @GetMapping("/nbPagesVenteLaptop")
    public ResponseEntity<Hashtable<String, Object>> getNbPagesVenteLaptop() {
        Hashtable<String, Object> result=new Hashtable<>();
        result.put("message", "Nombre de pages de ventes de laptop recuperee");
        result.put("data", laptopService.countNbpageVenteLaptop());
        result.put("status", HttpStatus.OK.value());
        return ResponseEntity.status(HttpStatus.OK).body(result);
    } 

    @GetMapping("/allVenteLaptop/{numPage}")
    public ResponseEntity<Hashtable<String, Object>> getAllVenteLaptop(
        @RequestHeader Map<String, String> headers, 
        @PathVariable int numPage,
        @RequestParam(required = false, defaultValue = "0") Integer idLaptop,
        @RequestParam(required = false, defaultValue = "0") Integer prixMin,
        @RequestParam(required = false, defaultValue = "0") Integer prixMax
    ) {
        Hashtable<String, Object> result=new Hashtable<>();
        result.put("message", "Vente de laptop recuperee");
        String token=headers.get("authorization").substring(7);
        result.put("data", laptopService.getAllVenteLaptopOfPointVente(token, numPage, idLaptop, prixMin, prixMax));
        result.put("status", HttpStatus.OK.value());
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    ...
    @GetMapping("/statBeneficeMois")
    public ResponseEntity<Hashtable<String, Object>> getStatOfBenefice(@RequestParam int annee)
    throws Exception {
        Hashtable<String, Object> result=new Hashtable<>();
        result.put("message", "Stat recuperee");
        result.put("data", laptopService.getStatBeneficeTotalMoisPDV(annee));
        result.put("status", HttpStatus.CREATED.value());
        return ResponseEntity.status(HttpStatus.CREATED).body(result);
    }

    @GetMapping("/statVenteMoisPDV")
    public ResponseEntity<Hashtable<String, Object>> getStatOfVentePDV(@RequestParam int annee, @RequestParam int idPointVente)
    throws Exception {
        Hashtable<String, Object> result=new Hashtable<>();
        result.put("message", "Stat recuperee");
        result.put("data", laptopService.getStatVenteTotalMoisPDV(annee, idPointVente));
        result.put("status", HttpStatus.CREATED.value());
        return ResponseEntity.status(HttpStatus.CREATED).body(result);
    }
}
