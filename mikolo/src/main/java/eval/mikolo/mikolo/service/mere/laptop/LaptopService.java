...
public class LaptopService {
    ...
    public TransfertLaptop transfererStockPointVente(TransfertLaptop transfertLaptop) throws Exception {
        ...
        transfertLaptop.setLaptop(laptop);
        transfertLaptop.setPrixAchat(laptop.getPrixAchat());
        transfertLaptop.setPrixVente(laptop.getPrixVente());
        ...
        StockLaptop stockLaptop=new StockLaptop(
            laptop, 
            0, 
            transfertLaptop.getQuantiteLaptop(), 
            transfertLaptop.getDateTransfertLaptop(), 
            laptop.getPrixAchat(), 
            laptop.getPrixVente()
        );
    ...
    throws Exception {
        StockPointVente stockPointVente=new StockPointVente(
            receptionLaptop.getTransfertLaptop().getPointVente(), 
            receptionLaptop.getTransfertLaptop().getLaptop(), 
            receptionLaptop.getQuantiteRecu(), 
            receptionLaptop.getDateReception()
        );
        ...
        if(
            receptionLaptop.getTransfertLaptop()
                            .getPointVente()
                            .getIdPointVente()!=pointVenteUser.getPointVente()
                                                                .getIdPointVente()
        ) {
        ...
        receptionLaptop.setQuantitePerdu(
            receptionLaptop.getTransfertLaptop().getQuantiteLaptop()-receptionLaptop.getQuantiteRecu()
        );
    ...
    public int countNbpageVenteLaptop() {
        return laptopRepository.countNbpageVenteLaptop();
    }
    ...
    public List<VenteLaptop> getAllVenteLaptopOfPointVente (
        String token, 
        int numPage, 
        Integer idLaptop, 
        Integer prixMin, 
        ...
        if(idLaptop==0) {
            if(prixMin==0) {
                if(prixMax==0) {
                    ...
                    return laptopRepository.findVenteLaptopByIdPointVente(
                        pdvService.findPointVenteOfUserConnected(token).getIdPointVente(), 
                        numPage
                    ); 
                }
                System.out.println("Cas 2");
                return laptopRepository.findVenteLaptopByIdPointVenteInfPrix(
                    pdvService.findPointVenteOfUserConnected(token).getIdPointVente(),
                    numPage, 
                    prixMax
                );
            ...
            if(prixMax==0) {
                ...
                return laptopRepository.findVenteLaptopByIdPointVenteSupPrix(
                    pdvService.findPointVenteOfUserConnected(token).getIdPointVente(),
                    numPage, 
                    prixMin
                );
            ...
            return laptopRepository.findVenteLaptopByIdPointVenteBetweenDeuxPrix(
                pdvService.findPointVenteOfUserConnected(token).getIdPointVente(), 
                numPage, 
                prixMin, 
                prixMax
        ...
        if(prixMin==0) {
            if(prixMax==0) {
                ...
                return laptopRepository.findVenteLaptopByIdLaptop(
                    pdvService.findPointVenteOfUserConnected(token).getIdPointVente(),  
                    numPage, 
                    idLaptop
                );
            ...
            return laptopRepository.findVenteLaptopByIdPointVenteAndIdLaptopInfPrix(
                pdvService.findPointVenteOfUserConnected(token).getIdPointVente(), 
                numPage, 
                idLaptop, 
                prixMax
        ...
        if(prixMax==0) {
            ...
            return laptopRepository.findVenteLaptopByIdPointVenteAndIdLaptopSupPrix(
                pdvService.findPointVenteOfUserConnected(token).getIdPointVente(), 
                numPage, 
                idLaptop, 
                prixMin
        ...
        return laptopRepository.findVenteLaptopByIdPointVenteAndIdLaptopBetweenDeuxPrix(
            pdvService.findPointVenteOfUserConnected(token).getIdPointVente(), 
            numPage, 
            idLaptop, 
            prixMin, 
    ...
    throws Exception {
        ...
        venteLaptop.setPrixVente(venteLaptop.getLaptop().getPrixVente());
        venteLaptop.setPrixAchat(venteLaptop.getLaptop().getPrixAchat());
    ...
    public List<StatVenteMoisPDV> getStatVenteTotalMoisPDV(int annee, int idPointVente) {
        return laptopRepository.getStatistiqueVenteTotalMoisParPDV(annee, idPointVente);
    }

    public List<StatBeneficeMois> getStatBeneficeTotalMoisPDV(int annee) {
        return laptopRepository.getStatistiqueBeneficeTotalMois(annee);
    }
}
